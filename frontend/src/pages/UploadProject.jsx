  ...
  return (
    <div className="max-w-2xl mx-auto mt-10 px-4">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-slate-800">Upload Circuit</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-white border border-slate-200 rounded-xl p-6 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="text-sm font-medium text-slate-700">Voltage (V)</label>
            <input
              type="number"
              step="0.1"
              className="mt-1 w-full border border-slate-300 rounded-md px-3 py-2"
          ...
          <div>
            <label className="text-sm font-medium text-slate-700">Current (mA)</label>
            <input
              type="number"
              step="1"
              className="mt-1 w-full border border-slate-300 rounded-md px-3 py-2"
        ...
        <div>
          <label className="text-sm font-medium text-slate-700">Component List (comma-separated)</label>
          <textarea
            required
            rows={4}
